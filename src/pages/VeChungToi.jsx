  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <section className="mb-8 bg-gradient-to-r from-indigo-500 to-[#00c9ff] rounded flex">
        <div className="marquee overflow-auto m-7">
          {" "}
          {/* Thêm overflow-auto */}
          <p className="text-lg text-white text-justify ">
            Chúng tôi cung cấp các khóa học trực tuyến chất lượng cao, giúp bạn
            phát triển kỹ năng và kiến thức một cách toàn diện. Với sứ mệnh mang
            lại trải <br /> nghiệm học tập tốt nhất, chúng tôi cam kết sử dụng
            các phương pháp giảng dạy hiện đại và hiệu quả. Đội ngũ giảng viên
            của chúng tôi là những <br /> chuyên gia hàng đầu trong lĩnh vực,
            luôn sẵn sàng hỗ trợ và hướng dẫn bạn trong suốt quá trình học. Mỗi
            khóa học được thiết kế tỉ mỉ, không chỉ
            <br /> cung cấp kiến thức lý thuyết mà còn chú trọng đến việc áp
            dụng thực tiễn.
            <br />
            Chúng tôi tin rằng học tập không chỉ là việc tiếp thu thông tin, mà
            còn là quá trình khám phá và thực hành. Bạn sẽ có cơ hội tham gia
            vào các dự án <br /> thực tế thảo luận nhóm và các hoạt động tương
            tác, giúp bạn nâng cao kỹ năng một cách hiệu quả.
            <br />
          </p>
        </div>
      </section>
